    ...
    <div className="p-6">
              ...
              >
                ...
                <td className="px-4 py-3 text-center">
                  <button
                    ...
                    className="px-4 py-2 text-sm bg-[#3f1a7b] text-white rounded hover:opacity-90"
                  >
                    View
                  </button>
                </td>
      ...
      {selected && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-90">
          <div className="bg-white rounded-xl w-11/12 max-w-lg overflow-hidden">
            {/* Modal Header */}
            <div className="bg-[#3f1a7b] text-white px-6 py-4 flex justify-between items-center">
            ...
            <div className="px-6 py-4 bg-gray-100 text-right">
              <button
                onClick={() => setSelected(null)}
                className="px-6 py-2 bg-[#3f1a7b] text-white rounded hover:opacity-90"
              >
                Close
              </button>
            </div>
